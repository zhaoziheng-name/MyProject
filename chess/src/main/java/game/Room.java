...
// 通过这个类来表示一个房间
// 每两个玩家就构成一个房间, 由于服务器的玩家可能很多
// 此时程序中就会有很多个房间实例(不是单例)
public class Room {
    ...
    public Room() {
        ...
        // 其他属性都是匹配/玩家对弈过程中设定的
        // roomId 要保证唯一性
        // 此处使用 uuid 来直接生成(所以把 roomId 设成 String)
    ...
    public void putChess(GameAPI.Request request) throws IOException {
        ...
        if (response.winner != 0) {
            ...
            System.out.println("游戏结束, 房间关闭! " + roomId);
        }
    }
